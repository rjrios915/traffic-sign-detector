...
SAVE_PATH = os.path.join(PROJECT_ROOT, "models", "SCRATCH_CNN.pt")
PLOT_DIR = os.path.join(PROJECT_ROOT, "results")
MODEL_PREFIX = "SCRATCH_CNN"
...
def train_model(cfg):
    ...
    model = ScratchCNNDetector(cfg.num_classes).to(DEVICE)
